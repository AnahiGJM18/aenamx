...
--
--
-- Name:    ECC_HL_HR_PuenSiniestralidad_SV 
--Tec
--
-- Desc:    Contiene el detalle de Siniestralidad. Personas 
--          Implicadas(PZEIH_DS) procedentes del módulo de RRHH
--
--          Reimplementación de desarrollo de BW
--              Transformación ODSO ZEIH_DS2 -> ODSO PZEIH_DS
--
--  Author: 
...
SELECT
    ...
    "0EHS_INJU"        AS "0EHS_BODY",  --Parte del cuerpo lesionada
    "0PAYRL_AREA",                      --Área de nómina
    "ZTPLUGAR",                         --Tipo de lugar
    "ZTPTRABJ",                         --Tipo de trabajo 
    'X'                AS "ZSTAT1",     --Status según las necesidades individuales del cliente #TODO:Incluye rutina con tabla de Empleados 
    "ZCNTPRL",
    "0AGE",
    "0GENDER",
    "ZARPERS",
