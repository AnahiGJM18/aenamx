...
SELECT 
    ...
    "MPACFIJ",                              ----Activo fijo
    '0000'               AS  "ZPOSICIO2",    ---Posición para Distribuir por CeCo,Cuenta BW
    'XXXX'               AS "OCHRT_ACCTS",  ----Plan de cuentas #TODO: Es una rutina ocupa la tabla de Division 
    'XXXXXXXXXXXXXXX'    AS "IMPORTE",      ----Importe Real Activo 
    "ZGAFFINV",                            ----Fecha de fin de inversiones 
    'XXXXX'              AS "0CURRENCY",    ----#TODO Clave de moneda / "viene de otra tabla" / es constante
    "MPVIDUTIL",                            
    "ZGAFFINV",                              ----Fecha de fin de inversión (días desde 00010101)
    "ZPROYEEPA"                             ----Proyecto Epa
FROM "ECC_HL_HR_CargadeActivosFijos_SV"